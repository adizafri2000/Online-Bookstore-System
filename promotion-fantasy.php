...
<?php
    ...
    $query = "select ISBN,bookName from book where genre='fantasy'";
...
<div id="promotion">
    ...
    <div id="book-space">
        <div id="book1">
            ...
            ?>">
                <figure>
                <img src="<?php echo"images/book-cover/fantasy/".$row[0]["ISBN"].".jpg";?>" width="80" height="120">
        ...
        <div id="book2">
            ...
            ?>">
                <figure>
                <img src="<?php echo"images/book-cover/fantasy/".$row[1]["ISBN"].".jpg";?>" width="80" height="120">
        ...
        <div id="book3">
            ...
            ?>">
                <figure>
                <img src="<?php echo"images/book-cover/fantasy/".$row[2]["ISBN"].".jpg";?>" width="80" height="120">
