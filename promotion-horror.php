...
<?php
    ...
    $query = "select ISBN,bookName from book where genre='horror'";
...
<div id="promotion">
    <div id="genre-title">
        <p>Send a spook down your bones...</p>
    </div>
    <div id="book-space">
        <div id="book1">
            <a href="<?php 
            ...
            ?>">
                <figure>
                <img src="<?php echo"images/book-cover/horror/".$row[0]["ISBN"].".jpg";?>" width="80" height="120">
        ...
        <div id="book2">
            ...
            ?>">
                <figure>
                <img src="<?php echo"images/book-cover/horror/".$row[1]["ISBN"].".jpg";?>" width="80" height="120">
        ...
        <div id="book3">
            ...
            ?>">
                <figure>
                <img src="<?php echo"images/book-cover/horror/".$row[2]["ISBN"].".jpg";?>" width="80" height="120">
